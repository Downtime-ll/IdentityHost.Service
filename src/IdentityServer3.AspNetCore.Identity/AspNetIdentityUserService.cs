...
namespace IdentityServer3.AspNetCore.Identity
{
    ...
    where TKey : IEquatable<TKey>
    {
        ...
        public AspNetIdentityUserService(UserManager<TUser> userManager, IOptions<AspNetCoreIdentityOptions> options)
        {
            _userManager = userManager;
            _enableSecurityStamp = options.Value.EnableSecurityStamp;
            _displayNameClaimType = options.Value.DisplayNameClaimType;
            _disableExternalAccountCreation = options.Value.DisableExternalAccountCreation;
        }
